...
4. packed=<yes/no>
   ...
   В случае, если значение - no, будет создан файл bootstrap.cmd и папка contents, содержащая откомпилированные скрипты.

   Если же значение - yes, файл bootstrap.cmd будет содержать распаковщик и сам архив.
